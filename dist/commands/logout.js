...
import { clearApiKey, clearAuthToken, hasAuthToken, } from "../lib/credentials.js";
...
export async function logoutCommand() {
    ...
    log.ok("Signed out");
    log.card("Local credentials updated", [alsoKey ? "Removed machine token and API key." : "Removed machine token."], "success");
