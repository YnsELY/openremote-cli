...
function findSessionFile(sessionId, updatedAt) {
    ...
    if (updatedAt) {
        ...
        if (!Number.isNaN(date.getTime())) {
            datedRoots.push(path.join(sessionsRoot, String(date.getUTCFullYear()), String(date.getUTCMonth() + 1).padStart(2, "0"), String(date.getUTCDate()).padStart(2, "0")));
        }
    }
...
export function findCodexSessionIdForProject(projectPath, startedAtMs) {
...
//# sourceMappingURL=codex-session-store.js.map